...
// Парсер разбирает формулу в систему вложенных структур, соответствующую заданное формулой выражение.
// Эта система структур называется Выражением. Кроме того, из Выражения вычленяются Переменные,
// а также строится Функция, которая реализует внутри себя операции наз Значениями, описанные формулой.
